...
const DataDeletionPolicy = () => {
  return (
    <div className="container mx-auto px-2 md:px-8 ">
      <h1 className="text-3xl font-semibold mb-4">Data Deletion Policy</h1>
      <p className="mb-6">
      ...
      <section className="mb-6">
        <h2 className="text-2xl font-medium mb-2">Your Right to Data Deletion</h2>
        <h3 className="text-xl font-medium mb-1">1. Requesting Data Deletion:</h3>
        ...
        <h3 className="text-xl font-medium mb-1">2. How to Request Data Deletion:</h3>
      ...
      <section className="mb-6">
        <h2 className="text-2xl font-medium mb-2">Our Data Deletion Process</h2>
        <h3 className="text-xl font-medium mb-1">1. Verification:</h3>
        <p className="mb-4">
        ...
        <h3 className="text-xl font-medium mb-1">2. Review and Confirmation:</h3>
        <p className="mb-4">
      ...
      <section className="mb-6">
        ...
        <h3 className="text-xl font-medium mb-1">1. Data Retention Requirements:</h3>
        <p className="mb-4">
      ...
      <section className="mb-6">
        <h2 className="text-2xl font-medium mb-2">Data Protection and Privacy</h2>

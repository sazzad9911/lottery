  ...
  return (
    <div className="container mx-auto px-2 md:px-8 ">
      ...
      <section className="mb-6">
        ...
        <h3 className="text-xl font-medium mb-1">
          {language === "en" ? "1. Verification:" : "১. যাচাইকরণ:"}
        </h3>
        <p className="mb-4">
          {language === "en"
        ...
        <h3 className="text-xl font-medium mb-1">
          {language === "en" ? "3. Data Deletion:" : "৩. ডেটা মুছে ফেলা:"}
        </h3>
        <p className="mb-4">
          {language === "en"
      ...
      <section className="mb-6">
        ...
        <h3 className="text-xl font-medium mb-1">
          {language === "en" ? "3. Backup Systems:" : "৩. ব্যাকআপ সিস্টেম:"}
        </h3>
        <p>
          {language === "en"
      ...
      <section className="mb-6">
        ...
        <p className="mb-4">
          {language === "en"
            ...
            : "আমরা মোছার প্রক্রিয়া চলাকালীন আপনার ব্যক্তিগত ডেটা সুরক্ষিত করার জন্য দৃঢ় নিরাপত্তা ব্যবস্থা নিযুক্ত করি। এটি নিশ্চিত করে যে আপনার ডেটা নিরাপদে মুছে ফেলা হয়েছে এবং অননুমোদিত পক্ষগুলি দ্বারা অ্যাক্সেস বা পুনরুদ্ধার করা যাবে না।"}
        </p>
        <h3 className="text-xl font-medium mb-1">
          {language === "en" ? "2. Compliance:" : "২. সম্মতি:"}
        </h3>
        <p>
          {language === "en"
            ...
            : "আমাদের ডেটা মুছে ফেলার অনুশীলনগুলি সাধারণ ডেটা সুরক্ষা নিয়ন্ত্রণ (GDPR) এবং অন্যান্য প্রযোজ্য আইন সহ প্রাসঙ্গিক ডেটা সুরক্ষা প্রবিধানগুলি মেনে চলে৷ আমরা আপনার ডেটা গোপনীয়তার অধিকার বজায় রাখতে এবং আমাদের ডেটা হ্যান্ডলিং অনুশীলনে স্বচ্ছতা বজায় রাখতে প্রতিশ্রুতিবদ্ধ।"}
        </p>
      </section>
      ...
      <section>
        ...
        {language === "en"
            ...
            : "আমাদের ডেটা মুছে ফেলার নীতি সম্পর্কে আপনার কোন প্রশ্ন বা উদ্বেগ থাকলে, অনুগ্রহ করে আমাদের গ্রাহক সহায়তা দলের সাথে যোগাযোগ করুন।"}
        </p>
      </section>
    </div>
  );
